...
void protobuf_AssignDesc_hybridsim_2eproto() {
  ...
  static const int Agent_offsets_[5] = {
  ...
  Trajectory_descriptor_ = file->message_type(5);
  static const int Trajectory_offsets_[4] = {
  ...
  Trajectories_descriptor_ = file->message_type(6);
