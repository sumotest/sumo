...
echo "for other OSs you need to get, build, and install grpc plugin by yourself"
case "$OSTYPE" in
...
protoc -I ./ --grpc_out=../../src/microsim/pedestrians  --plugin=protoc-gen-grpc=$PLUGIN_CPP $PROTO
protoc -I ./ --cpp_out=../../src/microsim/pedestrians $PROTO

#protoc -I ../src/main/proto --grpc_out=../../grpc-c++/src/  --plugin=protoc-gen-grpc=$PLUGIN_CPP $PROTO 
